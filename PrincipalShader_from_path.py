# copied from https://github.com/JoseZalez/Houdini-scripts/blob/master/PrincipalShader_from_path.py
# copied on 5/2/2022
    ...
    def createshader(self):
        ...
        for files in textures:
            ...
            if "color" in name or "diff" in name:
                ...
                hou.ui.displayMessage("Couldnt connect " + files,
                                      severity=hou.severityType.Message,
                                      default_choice=0, close_choice=0,
                                      title="Texture not applied",
